...
module('Unit | Model | base-channel', function (hooks) {
  ...
  test('#sortedUserList returns a list of sorted usernames', function (assert) {
    ...
    assert.deepEqual(channel.sortedUserList, [
      '@MrOps',
      '@operator',
      '&DaAdmin',
      '%HalfOp',
  ...
  test('#domain (XMPP)', function (assert) {
    ...
    assert.equal(
      channel.domain,
      'kosmos.chat',
      'returns the MUC domain for rooms'
    );
    ...
    assert.equal(
      channel.domain,
      'kosmos.chat',
      'returns the MUC domain for direct message channels'
    );
  });
  ...
  test('#domain (IRC)', function (assert) {
    ...
    assert.equal(
      channel.domain,
      'irc.libera.chat',
      'returns the network/account domain'
    );
  });
});
